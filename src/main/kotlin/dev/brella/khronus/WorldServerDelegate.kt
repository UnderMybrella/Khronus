...
open class WorldServerDelegate<T: WorldServer>(protected val world: WeakReference<T>) :
    WorldServer(world.get()?.minecraftServer!!, world.get()!!.saveHandler, world.get()!!.worldInfo, world.get()!!.provider.dimension, world.get()!!.profiler) {
...
//        val UPDATE_WEATHER
    ...
    override fun getChunkProvider(): ChunkProviderServer = world.get()!!.chunkProvider
